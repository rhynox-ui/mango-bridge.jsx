...
function ChainIcon({ id, size }) {
  ...
  if (id === "stable") {
    // NetworkStablechain does not actually exist in @web3icons/react's
    // exports — confirmed by a real build failure, not a guess. Reverted
    // to hand-drawn until the correct export name (if one exists) is
    // properly verified.
    return (

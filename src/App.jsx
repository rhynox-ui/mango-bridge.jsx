...
function ChainBadge({ id, size = 18 }) {
  ...
  // Real fix, same reasoning as the asset dropdown's SOL icon: Solana's
  // real logo (icons.sol.new) is a complete, self-contained badge SVG,
  // unlike the simple hand-drawn line-art used for other chains here —
  // wrapping it in another background circle created a visible
  // double-circle effect. Every other chain still gets the wrapping,
  // since their icons genuinely need it for contrast/consistency.
  if (id === "solana") {
    return (

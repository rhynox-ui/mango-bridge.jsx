...
function AssetIcon({ symbol, size = 18 }) {
  ...
  // examples exactly (TokenETH, TokenUSDC, TokenUSDT, TokenBNB) — no dynamic
  ...
  // one. Static imports have no such requirement. WBTC, USDT0, and anything
  // else not in this confirmed set use the hand-drawn fallback instead of
  // risking either failure mode again.

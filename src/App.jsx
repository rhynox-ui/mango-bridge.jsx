...
function ChainIcon({ id, size }) {
  ...
  const solanaFallback = (
    <svg width={sHand} height={sHand} viewBox="0 0 24 24" fill="none">
      <path d="M5 7h11l3 3H8L5 7z" fill="currentColor" opacity="0.85" />
      <path d="M5 17h11l3-3H8l-3 3z" fill="currentColor" opacity="0.85" />
      <path d="M5 12h11l3 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );

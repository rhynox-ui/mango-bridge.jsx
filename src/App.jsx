            ...
            <>
              ...
              <div className="rounded-2xl p-4 shadow-sm" style={{ background: P.panel, border: `1px solid ${P.panelBorder}` }}>
                <div className="flex items-center justify-between mb-2.5">
                  ...
                  <span className="text-[11.5px]" style={{ color: P.textMuted }}>
                    {usingLiveBalance
                      ? (liveBalanceLoading ? "Loading balance…" : `Balance: ${fmt(availableBalance, asset.decimals)} ${asset.symbol}`)
                      : "Balance: — (no live data for this pair)"}
                  </span>
                </div>
              ...
              <div className="rounded-2xl p-4 mt-3 shadow-sm" style={{ background: P.panel, border: `1px solid ${P.panelBorder}` }}>
                <div className="flex items-center justify-between mb-2.5">
                  ...
                  <span className="text-[11.5px]" style={{ color: P.textMuted }}>Balance: — (not fetched for destination yet)</span>
                </div>
                <div className="flex items-center justify-between mb-3">

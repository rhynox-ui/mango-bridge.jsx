...
import { isCctpSupportedPair, runCctpTransfer, CCTP_CHAINS } from "./cctp.js";
...
const CCTP_STEP_INDEX = { network: 0, approve: 0, burn: 1, attest: 2, "network-dest": 3, mint: 3 };

function BridgeModal({ from, to, amount, asset, fee, etaLabel, received, destination, account, onClose, onComplete }) {

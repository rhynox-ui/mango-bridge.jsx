...
async function getRelayChainIconUrl(chainId) {
  ...
  return chain?.currency?.metadata?.logoURI || null;
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(4,5,7,0.6)", backdropFilter: "blur(4px)" }}>
      <div className="w-full max-w-lg rounded-2xl p-6 max-h-[85vh] overflow-y-auto" style={{ background: P.bg, border: `1px solid ${P.panelBorder}` }}>
        ...
        <DocSection title="The Launchpad" P={P}>
          ...
          <p className="mb-2"><span className="font-medium" style={{ color: P.textPrimary }}>Trading fees:</span> 3% per trade, split 70% to the token's creator and 30% to the Mango Protocol treasury — paid automatically inside the same transaction as the trade. Nothing to claim, ever.</p>
        ...
        <DocSection title="Contracts" P={P}>
          <p className="mb-2">Deployed and verified on Robinhood Chain mainnet — tap either to view on the block explorer.</p>
          <div className="flex flex-col gap-2">
            <a href="https://robinhoodchain.blockscout.com/address/0x86a8899A5836fBf68F722f260E5106Cb03739040" target="_blank" rel="noopener noreferrer" className="rounded-lg p-3" style={{ background: P.panel, border: `1px solid ${P.panelBorder}` }}>
              <div className="text-[12px] font-medium mb-0.5" style={{ color: P.textPrimary }}>MangoLaunchHook</div>
            ...
            <a href="https://robinhoodchain.blockscout.com/address/0x3441E02E7e9C83EcA78d090Ef279faA7dd719023" target="_blank" rel="noopener noreferrer" className="rounded-lg p-3" style={{ background: P.panel, border: `1px solid ${P.panelBorder}` }}>
              <div className="text-[12px] font-medium mb-0.5" style={{ color: P.textPrimary }}>MangoLaunchRegistry</div>

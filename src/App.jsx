              ...
              <div className="mt-2 flex flex-col gap-2">
                ...
                {isReal ? (
                  <>
                    ...
                    >
                      View {kind === "op-deposit" || kind === "arb-deposit" ? "L1" : "burn"} tx on {a.name} <ExternalLink size={13} />
                    </a>
                    {realMintHash && (
                      <a
          ...
          {tab === "history" ? (
            ...
            <>
              ...
              <div className="text-center mt-4 text-[11.5px]" style={{ color: "#3A414C" }}>
                Testnet only. Real: Ethereum↔Base (USDC via CCTP, ETH via Base's bridge) and Ethereum↔Robinhood Chain (ETH via Arbitrum's bridge). All withdrawals take ~7 real days. BNB routes are still simulated.
              </div>

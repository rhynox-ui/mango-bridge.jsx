...
export const ASSET_ONCHAIN_DECIMALS = {
  ...
  WBTC: 8,
  USDT0: 18,
  // Solana's native asset uses 9 decimals (1 SOL = 1,000,000,000
  // lamports) — a well-established, verified fact about Solana's own
  // account model, not guessed or assumed from EVM conventions.
  SOL: 9,
};
